...
export function Footer() {
  return (
    <footer className="bg-[var(--lys-verde)] text-white overflow-hidden">
      {/* top editorial line */}
      <div className="container-lys pt-14 md:pt-20">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
          <div className="max-w-[520px]">
            ...
            <p className="mt-3 text-[12px] tracking-[0.28em] uppercase text-white/60">
          ...
          <div className="grid grid-cols-2 gap-10 text-sm md:gap-16">
            ...
            <nav aria-label="Footer editorial" className="flex flex-col gap-3">
              ...
              <a href="mailto:hello@lysandja.ao" className="text-white/70 hover:text-white transition-colors">hello@lysandja.ao</a>
            </nav>
          </div>
        </div>

        <div className="mt-14 flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-white/10 pt-6">
      ...
      <div className="select-none overflow-hidden border-t border-white/5 mt-10">
        <p className="font-display whitespace-nowrap text-[22vw] leading-none tracking-[-0.06em] text-white/[0.04] -mb-[0.12em] translate-y-2">
          LYSANDJA
        </p>
      </div>
    </footer>
