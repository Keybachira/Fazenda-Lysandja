...
export const processo = [
  {
    n: "01",
    title: "Preparar",
    desc: "Solo vivo: análise, correção e cobertura. O futuro começa abaixo da superfície.",
  },
  {
    n: "02",
    title: "Plantar",
    desc: "Janela certa, densidade certa, sementes certas — tecnologia a serviço do tempo da natureza.",
  },
  {
    n: "03",
    title: "Cuidar",
    desc: "Irrigação, monitorização e manejo integrado. Cada talhão observado com atenção.",
  },
  {
    n: "04",
    title: "Colher",
    desc: "Colheita no ponto ótimo — respeito ao grão, à fibra e à fibra humana que a torna possível.",
  },
  {
    n: "05",
    title: "Transformar",
    desc: "Beneficiamento e armazenamento com padrão de qualidade para chegar longe.",
  },
  {
    n: "06",
    title: "Entregar",
    desc: "Da nossa terra para o mundo — com origem, confiança e propósito.",
  },
] as const;
