export type Post = {
  ...
  title: string;
  excerpt: string;
  category: "Agricultura" | "Pessoas" | "Tecnologia" | "Sustentabilidade" | "Vida na Fazenda";
  date: string;
  image: string;
  featured?: boolean;
};
...
export const posts: Post[] = [
  {
    ...
    excerpt: "Um dia dentro da operação Lysandja — do nascer do sol à leitura dos talhões.",
    category: "Vida na Fazenda",
    date: "2026-04-12",
    image: "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=1200&q=80&auto=format&fit=crop",
    featured: true,
  },
  {
    slug: "agua-que-conta",
    title: "A água que conta",
    excerpt: "Como gerir cada gota quando o clima muda e a responsabilidade aumenta.",
